...
namespace library_class
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BooksAndLibrary();
            SomeTests();
            FindingAndGivingBooks();
            
        }
        static void FindingAndGivingBooks()
        {
            //Test 3
            ...
            for (int i = 0; i < MyThirdLibrary.GetSection.Count; i++)
            {
                AvailableBooks = MyThirdLibrary.SearchIsAvailableBooks();
            }
        ...
        static void BooksAndLibrary()
        {
            ...
            Section Adilts = new Section(ForAdults, "Adults");
            Section Kids = new Section(ForKids, "Kids");
            List<Section> MySections = new List<Section>() { Adilts, Kids };
        ...
        //static string CheckoutGenreOf(string s)
        //{
        //    Console.WriteLine($@"Please input the genre of {s}: gitakan, gexarvestakan, erajshtakan,
        //        gexankarchakan, mankakan, bjshkakan");
        //    string genre = Console.ReadLine();
        //    if (genre != "gitakan" && genre != "gexarvestakan" && genre != "erajshtakan"
        //                && genre != "gexankarchakan" && genre != "mankakan" && genre != "bjshkakan")
        //    {
        //            Console.WriteLine("This is not a valid genre.Try again.");
